...
class Uploader:
    ...
    def upload(
        ...
        try:
            ...
            resource_url = Uploader.upload_resource(
                metadata_id,
                filepath,
                res_metadata,
                filepath
            ...
            Uploader.delete_metadata(metadata_id)
...
class MockUploader:
    @staticmethod
    def upload_metadata(metadata: DatalakeMetadata):
        return 'mock_metadata_id'
    @staticmethod
    def upload_resource(metadata_id: str, filepath: str, resource_metadata: DatalakeResourceMetadata, filename: str):
        return 'mock_resource_url'
    @staticmethod
    def upload(metadata_id: str, filepath: str, file_date_start:datetime, file_date_end:datetime, format:str='GeoJSON', request_code:str=None, datatype_resource: int = None):
        return 'mock_resource_url'